...
$productos = (new Productos())->obtener_componentes();
$categorias = (new Categorias)->categorias_componentes();
$marcas_procesadores = (new Marcas)->obtener_marcas_procesadores();
$marcas_placas_de_video = (new Marcas)->obtener_marcas_placas_de_video();
...
<div class="d-flex justify-content-around">
    <div id="productos" class="d-flex flex-wrap justify-content-center">
        <p class="container-fluid me-5 ms-5 fs-4 col-10"> <?= $categoria == false ?  "Todos los componentes" : $categoria ?></p>
            ...
            <li>
                ...
                <ul>
                    <?php foreach ($categorias as $categoria) { ?>
                        <li><a href=" index.php?seccion=componentes&categoria=<?= $categoria->getCategoria() ?>&id=<?= $categoria->getId() ?>"><?= $categoria->getCategoria() ?></a></li>
                    <?php }; ?>
                </ul>
            </li>
        </ul>
