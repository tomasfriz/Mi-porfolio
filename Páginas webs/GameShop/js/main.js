...
fetch("./json/productos.json")
    ...
    .then(data => {
        ...
        backup.agregar("productos", productos);
    })
...
// Agrega el producto al carrito, carga el producto al localStorage y suma la cantidad de productos que estan en el carrito a 1 el contador
